...
python AveragedDQN_lunarLander.py --gpu_no=1 --seed=7 --num_model=$NUM_MODEL --env_name=$ENV --n_episodes=$N_EPISODES --lr=$LR &
python AveragedDQN_lunarLander.py --gpu_no=1 --seed=8 --num_model=$NUM_MODEL --env_name=$ENV --n_episodes=$N_EPISODES --lr=$LR
